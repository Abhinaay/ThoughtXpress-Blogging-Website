...
var DynamicLoaderService = /** @class */ (function () {
    function DynamicLoaderService() {
        this.subject = new BehaviorSubject(null);
    }
    DynamicLoaderService.prototype.getLoaderData = function () {
        return this.subject.asObservable();
    };
    DynamicLoaderService.prototype.show = function () {
        this.subject.next({ show: true });
    };
    DynamicLoaderService.prototype.hide = function () {
...
var DynamicLoaderComponent = /** @class */ (function () {
    function DynamicLoaderComponent(loaderService) {
     ...
     */
    DynamicLoaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log(this.isFullScreen);
        this.loaderService.getLoaderData().subscribe(function (loaderData) {
            if (loaderData) {
                loaderData.show ? _this.isShow = true : _this.isShow = false; // Toggle loader
            }
        });
        if (!this.loaderType) {
    ...
    DynamicLoaderComponent.prototype.ngOnDestroy = function () {
        this.isFullScreen = undefined;
    };
    DynamicLoaderComponent.ctorParameters = function () { return [
...
var DynamicLoaderModule = /** @class */ (function () {
    function DynamicLoaderModule() {
    }
